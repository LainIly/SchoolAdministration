...
namespace SchoolAdministration.Main.AppBootstrapper.CoursesModule
{
    public class CoursesModule
    {
        ...
        public CoursesModule(ICourseRepository courseRepository, ITeachersRepository teachersRepository)
        {
        ...
        public ICourseController Build(INotificationService notificationService)
        {
            ...
            return new CourseController(courseService, notificationService, inputHelper, teacherService);
        }
    }
}
